...
prob.driver.options['optimizer'] = 'BFGS'#'ALPSO'#'SLSQP'#"Powell"#COBYLA, Powell works, COBYLA works, Nelder-Mead works but violates constraints, own PSO works, 
=======
prob.driver = pyOptSparseDriver()
# prob.driver = ScipyOptimizer()
prob.driver.options['optimizer'] = 'NSGA2'#'SLSQP'#"Powell"#COBYLA, Powell works, COBYLA works, Nelder-Mead works but violates constraints, own PSO works, 
...
print(prob['indep2.layout'])
with open("layout_opt_irreg_cg.dat", "w") as out:
