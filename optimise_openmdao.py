...
prob.driver.options['optimizer'] = 'Nelder-Mead'#'SLSQP'#"Powell"#COBYLA, Powell works, COBYLA works, Nelder-Mead works but violates constraints, own PSO works, 
...
print(prob['indep2.layout'])
with open("layout_opt_3.dat", "w") as out:
