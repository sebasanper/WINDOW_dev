...
from farm_description import read_cablelist, number_turbines_per_cable
...
def draw_cables(WT_List, central_platform_locations):
    NT = len(WT_List)
    ...
    def set_cable_topology(WT_List, central_platform_locations, Cable_List):
        ...
        return total_cost, Routesi, cable_length
...
if __name__ == '__main__':
   ...
   #  central_platform_locations = [[4000.0, 4000.0], [3000.0, 3000.0]]
   #  # List of cable types: [Capacity,Cost] in increasing order (maximum 3 cable types)
   ...
   #  Area = [[[491858.09, 5725044.65], [502208.11, 5738192.56]], [[508800.53, 5726317.36], [491112.91, 5734678.83]], [[487136.52, 5729617.8], [496459.2, 5732167.05]], [[496459.2, 5732167.05], [500959.72, 5737797.21]], [[494364.31, 5722617.21], [502992.7, 5734016.99]], [[502992.7, 5734016.99], [505471.71, 5734528.44]], [[505471.71, 5734528.44], [506574.97, 5735738.54]], [[501212.81, 5715983.99], [501194.99, 5718210.4]], [[501194.99, 5718210.4], [504863.36, 5738179.94]]]
    ...
    from farm_description import n_quadrilaterals, areas, separation_equation_y, NT, central_platform, read_cablelist, number_turbines_per_cable
    from turbine_description import rated_current
