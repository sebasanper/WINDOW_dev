...
def jensen_1angle(layout_x, layout_y, wind_speed, angle, rotor_radius, k):
    ...
    deficit_matrix[distance[i][1]][distance[turbine][1]] = Parallel(n_jobs=-1)(delayed(loop1)(i) for i in range(turbine + 1, nt))
...
if __name__ == '__main__':
    with open('discretise.dat', 'w', 1) as out:
        res1 = ainslie_1angle([0., 560.0, 1120., 1680., 2240., 2800., 3360., 3920., 4480.],
                       [0., 0., 0., 0., 0., 0., 0., 0., 0.], 8.5, 180.0, 40.0, 0.08, 0.001)
        for j in range(9):
        ...
        for i in range(50):
            ...
            res2 = ainsliefull_1angle([0., 560.0, 1120., 1680., 2240., 2800., 3360., 3920., 4480.],
                           [0., 0., 0., 0., 0., 0., 0., 0., 0.], 8.5, 0.0, 40.0, 0.08, disc)
            for j in range(9):
