...
if __name__ == '__main__':
    ...
    print max_turbulence_one_angle(layout, U_inf, 0.0, I0, Jensen, thrust_coefficient, "/home/sebasanper/PycharmProjects/WINDOW-dev/farm_energy/wake_model_mean_new/aero_power_ct_models/windsim_ct.dat", frandsen2)
